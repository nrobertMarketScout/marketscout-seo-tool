                  ...
                  <TextInput
                    label={
                      <span className="flex items-center gap-1">
                        OG Title <HelpTip text="Open Graph title in social previews" />
                      </span>
                    }
                    val={ogTitle}
                    setVal={setOgTitle}
            ...
            <div ref={resultRef} className="mt-8 space-y-4 rounded-3xl bg-white/95 p-8 shadow-lg backdrop-blur">
              ...
              <div className="flex flex-wrap gap-3">
                <a
                  ...
                  className="rounded-lg bg-gray-200 px-4 py-2 text-gray-800 shadow hover:bg-gray-300"
                >
                  Download
                </a>
                <a
                ...
                {mode === 'lite' ? (
                  ...
                  >
                    ...
                    {['index', 'services', 'about', 'contact'].map(p => (
                      <option key={p}>{p}.html</option>
                    ))}
                  </select>
                )}
              </div>
